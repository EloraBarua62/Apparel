      ...
      <div className={`${styles.banner_section} slider-container`}>
        <Slider {...settings}>
          <div className={styles.slider_image_container}>
            <Image priority={true} src={slide1} alt="" className={styles.image_design} />
          ...
          <div className={styles.slider_image_container}>
            <Image priority={true} src={slide2} alt="" className={styles.image_design} />
          ...
          <div className={styles.slider_image_container}>
            <Image priority={true} src={slide3} alt="" className={styles.image_design} />
